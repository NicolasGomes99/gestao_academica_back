...
public class UnidadeAdministrativaController {
    ...
    @PostMapping("/{id}/gestor/{gestorId}")
...
//    @PostMapping("/{id}/tecnico/{tecnicoId}")
//    public ResponseEntity<Void> adicionarTecnico(@PathVariable Long id, @PathVariable Long tecnicoId) {
